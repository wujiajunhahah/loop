...
const journeyData = {
  ...
  speak: {
    overline: '我在，你说',
    title: '让今天，遇见一段真实的过去',
    description: '你可以放进今天的一张照片、一句话或一段声音。系统只在被授权的旧记录中寻找关联，不假装对方正在回复。',
    points: ['关联理由清楚可见', '不使用聊天气泡制造在线错觉', '没有依据时允许沉默'],
  ...
  seek: {
    overline: '我在，你寻',
    title: '一问一答，找回故事的轮廓',
    description: '从一张局部照片、一件物品或一句原话出发，慢慢理解一段珍贵经历。重点不是猜中，而是参与和回顾。',
    points: ['答案只来自真实记录', '随时可以直接看完整故事', '重要告别永远不会被锁住'],
  ...
  do: {
    overline: '我在，你做',
    title: '把一份愿望，变成轻一点的行动',
    description: '只有创作者明确留下的愿望，才会被整理成可选择、可缩小、也可以拒绝的小行动。愿望从来不是义务。',
    points: ['不做也完全可以', '默认不提醒、不打卡', '行动产生的内容属于你'],
    visual: '<div class="mode-visual do-visual"><small>一份本人留下的愿望</small><blockquote>“心里乱的时候，就出去走一小段。”</blockquote><div class="do-options"><span>走 5 分钟</span><span>改轻一点</span><span>以后再说</span><span>我不想做</span></div></div>',
  },
  live: {
    overline: '你在',
    title: '今天的生活，重新成为主角',
    description: '你在看、说、寻找和行动中留下的新内容，会逐渐成为自己的生活记录。过去安静地被收藏，而你继续创造新的今天。',
    points: ['新内容归接收者自己所有', '系统主动建议降低频率', '可独立导出，也可选择放下'],
    visual: '<div class="mode-visual live-visual"><span class="sun-disc"></span><div class="life-card"><small>今天 · 属于你的 Context</small><p>“原来独立里，也有被看见。”</p></div></div>',
  },
};
